    ...
    <el-form :model="formData" :rules="rules">
      <el-form-item prop="name">
        <el-row :gutter="20">
          ...
          <el-col :span="10"><el-input v-model="formData.name"></el-input></el-col>
        </el-row>
      </el-form-item>
      <el-form-item prop="location">
        <el-row :gutter="20">
          <el-col class="label" :span="2">地理位置</el-col>
          <el-col :span="10"><el-input v-model="formData.location"></el-input></el-col>
        </el-row>
      </el-form-item>
      <el-form-item>
        <el-row :gutter="20">
      ...
      <el-form-item prop="phone">
        <el-row :gutter="20">
          ...
          <el-col :span="10"><el-input v-model="formData.phone"></el-input></el-col>
        </el-row>
      </el-form-item>
      <el-form-item prop="profile">
        <el-row :gutter="20">
          <el-col class="label" :span="2">店铺简介</el-col>
          <el-col :span="10"><el-input type="textarea" maxlength="50" show-word-limit v-model="formData.profile"></el-input></el-col>
        </el-row>
      </el-form-item>
    </el-form>
    <el-form>
